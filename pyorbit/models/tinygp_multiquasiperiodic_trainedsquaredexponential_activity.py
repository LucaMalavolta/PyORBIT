...
try:
    ...
    @jax.jit
    def _condition_tinygp_multiQP_trainedSE(params):
        gp = _build_tinygp_multiQP_trainedSE(params)
...
class TinyGP_MultiQuasiPeriodic_TrainedSquaredExponential_Activity(AbstractModel, AbstractGaussianProcesses):
    ...
    def lnlk_rvonly_compute(self):
        ...
        _, cond_gp = _condition_tinygp_multiQP_trainedSE(theta_dict)
