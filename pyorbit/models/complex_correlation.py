...
class LocalCorrelation(AbstractModel):
    ...
    def compute(self, parameter_values, independent_dataset, x0_input=None):
        ...
        if x0_input is None:
            return polynomial.polyval(
                independent_dataset.residuals - parameter_values['x_zero'],coeff)
        else:
            return 0.00
