...
class GaussianProcess_QuasiPeriodicActivity_Shared(AbstractModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.model_class = 'gp_quasiperiodic_shared'
    ...
    def add_internal_dataset(self, variable_value, dataset, reset_status):
        ...
        self.internal_dataset['yr'].extend(
            dataset.residuals*variable_value['Hamp_factor'])

        self.internal_dataset['ej'].extend(
            np.sqrt(dataset.e**2.0 + dataset.jitter**2.0)*variable_value['Hamp_factor'])
